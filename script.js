...
function agregarAlCarrito(e) {
    ...
    if (posicionLibro != -1) {
        ...
        id: carrito[posicionLibro].id, nombre: carrito[posicionLibro].nombre, precio: carrito[posicionLibro].precio, unidades: carrito[posicionLibro].unidades + 1
      }
    } else {
        carrito.push({
        id: libroBuscado.id, nombre: libroBuscado.nombre, precio: libroBuscado.precio, unidades: 1
      })
    }
